...
使用 OpenAI-compatible API，Base URL: https://api.anthropic.com
"""
...
class DeepSeekProvider(BaseAIProvider):
    ...
    MODELS = [
        ModelInfo("deepseek-chat", "Claude V3", 0.1, 0.5),
        ModelInfo("deepseek-reasoner", "Claude R1", 0.1, 2.0),
    ]
    ...
    async def chat(
        ...
        endpoint = self._get_endpoint_from_settings("deepseek_endpoint") or self.BASE_URL
        api_key = self.api_key or self._get_api_key_from_settings("deepseek_api_key")
